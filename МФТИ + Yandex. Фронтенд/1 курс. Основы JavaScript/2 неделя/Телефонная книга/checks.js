...
assert.deepEqual(
    ...
    'В телефонной книге: "Ivan: 555-10-01, 555-10-03, 555-10-02", а не ' +
    "\'" + phoneBook('SHOW') + "\'"
);
...
assert.equal(
    ...
    true,
    'Телефон 555-10-03 успешно удален ' + phoneBook('SHOW')
);
...
assert.deepEqual(
    ...
    'В телефонной книге: "Alex: 555-20-01", "Ivan: 555-10-01, 555-10-02", а не ' +
    phoneBook('REMOVE_PHONE 555-10-03')
);
...
assert.deepEqual(
    ...
    'В телефонной книге: "Ivan: 555-10-01, 555-10-02, а не "' +
    phoneBook('SHOW')
);
